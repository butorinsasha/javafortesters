...
public class Ch15p156ComparingStringTest {
    ...
    @Test
    public void equalsEqualsForCharSequenceInterfaceImplementedClasses() {
        String str = "AbrAcAdAbrA";
...
//                                             0123456789
    ...
    @Test
    public void indexOfReturnsStartPositionOfSubstring() {
...
//        actualsList.add(10);
    ...
    @Test
    public void findAllOccurrencesFindsAllSubstringLocationsInTheGivenString() {
...
//        int[] expectedsArray = {0, 7};
        Integer[] expectedsArray = {0, 7};


        /*Generating expectedsList data from expectedsArray*/

        List<Integer> expectedsList = Arrays.asList(expectedsArray);
        System.out.println(expectedsList.getClass());
